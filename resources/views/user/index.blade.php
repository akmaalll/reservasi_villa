                        ...
                        <div class="content-text p-4">
                            ...
                            <form action="#">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" class="form-control" id="mm" placeholder="MM">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="country" name="villa_id" class="custom-select">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select id="country" name="villa_id" class="custom-select">
                                        <option value="Afghanistan">Tunai</option>
                                        <option value="Afghanistan">Transfer</option>
                                    </select>
                                </div>
                                ...
                                <p>Harus Login Dulu Ketika ingin reservasi. <a href="{{ route('login') }}">Disini</a>
                                </p>
                            </form>
                        </div>
                    </div>
